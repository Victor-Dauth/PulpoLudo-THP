class Admin::UsersController < Admin::BaseController
  ...
  def index
    ...
    @column_names = ["id", "email","first_name", "last_name", "date_of_birth", "phone_number", "gender", "stripe_id", "is_admin?"]
    
    @column_names_non_visible = ["encrypted_password", "reset_password_token", "reset_password_sent_at", "remember_created_at", "created_at", "updated_at"]
